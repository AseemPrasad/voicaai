...
exports.analyzeWithRules = void 0;
...
const findBestMatch = (text, rules, defaultMatch) => {
...
const analyzeWithRules = (message) => {
    const cleanedText = (0, parser_1.cleanText)(message);
